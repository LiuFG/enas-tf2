...
DEFINE_string("data_path", "/home/liufg/data/cifar/cifar10", "")
DEFINE_string("output_dir", "./output_micro", "")
...
def get_ops(images, labels):
  ...
  if FLAGS.child_fixed_arc is None:
    ...
    child_model.connect_controller(controller_model)   # build child & child train
    controller_model.build_trainer(child_model)        # 计算reward，通过PG算loss，确定train_op
